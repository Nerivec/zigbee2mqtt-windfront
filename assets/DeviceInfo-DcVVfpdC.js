import{E,P as T,b as f,r as o,j as e,Q as U,C as N,F as p,R as M,a as x,k as h,c as u,L as _,$ as O,aD as v,aE as A,aF as y,aB as z,t as I,M as H,S as q,A as F,aG as S,aC as k}from"./index-stPJGdJU.js";import{s as G}from"./snakeCase-C6cqTDbn.js";import{a as W,A as B,D as V}from"./Availability-DL-GmxfL.js";import{T as J}from"./TextareaField-rngJnTKa.js";import{D as K}from"./DeviceImage-BPbPxGIb.js";import{D as Q}from"./DisplayValue-BRXvKv30.js";import{L as X}from"./LastSeen-CGrqPwUd.js";import{M as Y,V as Z}from"./VendorLink-DYeRya3q.js";import{P as ee}from"./PowerSource-DMo29D7Y.js";import"./envs-CSqIi4cL.js";import"./_createCompounder-DzbcSJDw.js";import"./isArray-C00_ZRoj.js";import"./RemoveDeviceModal-BHo1gU-K.js";import"./CheckboxField-CScarrH0.js";import"./InputField-Cc4_ou-U.js";import"./index-ClDGAc5M.js";import"./format-BgD0SSns.js";const se=E.create(({device:a,setDeviceDescription:s})=>{const i=T(),{t:n}=f(["zigbee","common"]),[l,m]=o.useState(a.description||"");return o.useEffect(()=>{m(a.description||"")},[a.description]),o.useEffect(()=>{const r=d=>{d.key==="Escape"&&(d.preventDefault(),i.remove())};return window.addEventListener("keydown",r),()=>window.removeEventListener("keydown",r)},[i]),e.jsx(U,{isOpen:i.visible,title:`${n(r=>r.update_description)} ${a.friendly_name}`,footer:e.jsxs(e.Fragment,{children:[e.jsx(N,{className:"btn btn-neutral",onClick:i.remove,children:n(r=>r.cancel,{ns:"common"})}),e.jsx(N,{className:"btn btn-primary ms-1",onClick:async()=>{i.remove(),await s(a.ieee_address,l)},children:n(r=>r.save_description)})]}),children:e.jsx("div",{className:"flex flex-col gap-2",children:e.jsx(J,{label:n(r=>r.description),name:"update_description",onChange:r=>m(r.target.value),rows:3,value:l})})})}),te=o.memo(({device:a,setDeviceDescription:s})=>{const{t:i}=f("zigbee");return e.jsx(N,{className:`btn btn-link btn-sm${a.description?" btn-square":""}`,onClick:async()=>await E.show(se,{device:a,setDeviceDescription:s}),title:i(n=>n.edit_description),children:a.description?e.jsx(p,{icon:M}):i(n=>n.edit_description)})}),ae=/\[(.*?)]\((.*?)\)/,ie={native:"badge-success",external:"badge-info",generated:"badge-warning"},ne=(a,s)=>{if(!(a==="bindings"||a==="configured_reportings"||a==="scenes"))return s},re=o.memo(({device:a})=>{const{t:s}=f("zigbee"),i={labels:"enhancement",title:`[External Converter] ${a.model_id} from ${a.manufacturer}`,body:`<!--
